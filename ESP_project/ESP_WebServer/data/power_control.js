...
if (localStorage.getItem("lower_range_value") == null) 
    localStorage.setItem('lower_range_value', 40);
if (localStorage.getItem("upper_range_value") == null) 
    localStorage.setItem('upper_range_value', 80);
if (localStorage.getItem("charging_time") == null) 
    localStorage.setItem('charging_time', 0);

var battery_percentage_value; 
setInterval(() => { battery_percentage_value = localStorage.getItem('battery_percentage_value'); }, 1000);

var lower_range_value = localStorage.getItem('lower_range_value');
var upper_range_value = localStorage.getItem('upper_range_value');
var charging_time = localStorage.getItem('charging_time');

var automatic_range_active = true;
var lower_range_active = false;
var upper_range_active = false;
var charg_time_out = false;
